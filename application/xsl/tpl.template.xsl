...
>
	...
	<xsl:template name="trip_saved">
		...
		<!-- Google Code for Sparad resa Conversion Page -->
		<script type="text/javascript">
		/* <![CDATA[ */
		var google_conversion_id = 993152712;
		var google_conversion_language = "sv";
		var google_conversion_format = "2";
		var google_conversion_color = "ffffff";
		var google_conversion_label = "QpfrCPjP2AIQyJ3J2QM";
		var google_conversion_value = 0;
		if (120) {
		  google_conversion_value = 120;
		}
		/* ]]> */
		</script>
		...
		<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/993152712/?value=120&amp;label=QpfrCPjP2AIQyJ3J2QM&amp;guid=ON&amp;script=0"/>
		</div>
		</noscript>
